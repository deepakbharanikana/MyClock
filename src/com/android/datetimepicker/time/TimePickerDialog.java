...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedColor = res.getColor(mThemeDark? R.color.red : R.color.accent);
        ...
        int primary = res.getColor(R.color.primary_color);
        ...
        view.findViewById(R.id.time_display_background).setBackgroundColor(mThemeDark? darkGray : primary);
        view.findViewById(R.id.time_display).setBackgroundColor(mThemeDark? darkGray : primary);
